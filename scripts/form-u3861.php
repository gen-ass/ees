...
function emailFormSubmission()
{
	...
	$to = 'saeliteelectrical@gmail.com,elite.electricalsa@outlook.com,chrisliebenberg@live.co.za';
	$subject = 'Elite Electrical Services Form Submission';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Name:</b></td><td>' . htmlentities($_REQUEST["custom_U3869"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Message:</b></td><td>' . htmlentities($_REQUEST["custom_U3863"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	...
	$headers = 'From: saeliteelectrical@gmail.com' . PHP_EOL . 'Reply-To: ' . $formEmail . PHP_EOL .'X-Mailer: Adobe Muse 2014.0.30 with PHP/' . phpversion() .'/'. PHP_OS . PHP_EOL . 'Content-type: text/html; charset=utf-8' . PHP_EOL;
	
	$sent = @mail($to, $subject, $message, $headers);
	
	if($sent)
	{
		echo '{"FormResponse": { "success": true,"redirect":"index.html#about"}}';
